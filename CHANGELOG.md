...
* add skip-tag to changelog workflow ([30a4e6e](https://github.com/IEEE-Student-Branch-GEHU/IEEESoC.web/commit/30a4e6e004596c9f68ce15fd99dc4ebbe27b5352))
...
* changelog action creates PR instead of pushing directly ([24b94b2](https://github.com/IEEE-Student-Branch-GEHU/IEEESoC.web/commit/24b94b2fbf481a0e8664b53351dd929580a7f2cb))
...
* push changelog to branch instead of creating PR ([faf6675](https://github.com/IEEE-Student-Branch-GEHU/IEEESoC.web/commit/faf6675dd77ef685b9720ce294d0f501761d47e4))
...
* use gh pr create instead of peter-evans action ([f05e7d5](https://github.com/IEEE-Student-Branch-GEHU/IEEESoC.web/commit/f05e7d5481f968e4fd517c22f92ad32929993b7d))
...
* use peter-evans/create-pull-request for changelog PRs ([e16e082](https://github.com/IEEE-Student-Branch-GEHU/IEEESoC.web/commit/e16e082d9503ab95d2dfb177ec83429adf6d78f7))
...
* seed all project admin details from form responses into Project Crate section ([f450d25](https://github.com/IEEE-Student-Branch-GEHU/IEEESoC.web/commit/f450d2597bf9189370ffb5555bf55a87a7fd8697))
